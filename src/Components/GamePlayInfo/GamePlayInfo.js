    ...
    return(
        <>
            ...
            <div className={"SMTControl"}>
                <p className={"Player"}>User - <span style={{color:"aqua"}}>{props.state.UserName}</span></p>
                <p className={"Score"}>Score = <span style={props.state.RightScore > 0 ? {color:'orange'}:{color:"red"}}>{props.state.RightScore}</span></p>
